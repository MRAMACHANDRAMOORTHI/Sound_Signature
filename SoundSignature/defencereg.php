...
<head>
    ...
    <title>Defence Registration</title>
</head>   
    ...
    if(pointform.u1.value==""  || pointform.x1.value=="" || pointform.y1.value=="" || pointform.x2.value==""  || pointform.y2.value=="" || pointform.x3.value=="" || pointform.y3.value=="" || pointform.x4.value=="" || pointform.y4.value=="" || pointform.x5.value=="" || pointform.y5.value=="")
{
        ...
        {
            pointform.action="defenceprocess1.php";
            pointform.submit();
        }
}
</script>
...
?>
   ...
   <form name="pointform" method="post">
        ...
        <thead>
            <tr>
                <th style="background-color:yellow;color:maroon;font-weight:1200" colspan="2">DEFENCE REGISTRATION</th>
        ...
        <td>            
<img src="Image/defence-1.jpg"  onclick="point_it1(event)" id="cross1" height="200" width="200" >

<img src="Image/dence2.jpg" onclick="point_it2(event)" id="cross2" height="200" width="200" >

<img src="Image/defence3.jpg"  onclick="point_it3(event)" id="cross3" height="200" width="200" >

<img src="Image/dence4.jpg"  onclick="point_it4(event)" id="cross4" height="200" width="200" >

<img src="Image/india-defence-1.jpg"  onclick="point_it5(event)" id="cross5" height="200" width="200" >
    ...
    <tr>
        <th colspan="2">
        <input type="button" value="Proceed" style="background-color:white"  onclick="valid()"/>
